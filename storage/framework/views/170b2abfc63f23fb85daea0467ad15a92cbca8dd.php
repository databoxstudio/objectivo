                ...
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                  <h6 class="card-title mb-0">Agents</h6>
                   ...
                   <div class="dropdown mb-2">
                      ...
                      <a class="btn btn-success" href="<?php echo e(route('agentsModule.exportAgents')); ?>"> <span class="">Export Agents</span></a>
                  ...
                  <table class="table table-hover mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php if(@$user->supervisor->first_name != '' || @$user->supervisor->last_name != ''): ?>
                        <td><?php echo e(@$user->supervisor->first_name); ?> <?php echo e(@$user->supervisor->last_name); ?></td>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/objectivo/domains/objectivo.in/public_html/resources/views/AgentModule/index.blade.php ENDPATH**/ ?>