                  ...
                  <div class="row">
                                             <div class="col-sm-4">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" value="{{$users->wareHouse->name}}" class="form-control" id="phone_number" name="phone_number" disabled="disabled">
                                                </div>
                                            </div><!-- Col -->
                                             <div class="col-sm-4"
                                            ...
                                            <div class="col-sm-4">
                                             ...
                                             <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" value="{{$users->email}}" class="form-control" id="email" name="email" disabled="disabled">
                                                </div>
                                            </div><!-- Col -->
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{$users->fathers_name}}" disabled="disabled">
                                                </div>
                                            </div><!-- Col -->
                                        </div><!-- Row -->
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control" value="{{$users->blood_group}}"  name="dob" disabled="disabled">
                                                </div>
                                            </div><!-- Col -->
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label">City</label>
                                                     <input type="text" class="form-control" value="{{$users->localCity->name}}"  name="city" disabled="disabled">
                                                </div>
                                            </div><!-- Col -->
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label">City</label>
                                                     <input type="text" class="form-control" value="{{$users->permanentCity->name}}"  name="permanent_address_city" disabled="disabled">
