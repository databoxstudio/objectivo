...
<div class="row">
                ...
                @endif
                                <h6 class="card-title">Edit Page</h6>
                                    <form class="forms-sample" action="/ManagePagesModule/PharmaCategories" method="post">
                {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Page Title</label>
                                                    <input type="text" class="form-control" id="page_title" name="page_title" autocomplete="off" placeholder="Page Title">
                                                </div>
                                            </div><!-- Col -->
                                          ...
                                          <div class="row">
                                            <div class="col-sm-6">
                                                  <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="page_seodescription" id="page_seodescription" rows="10"    ></textarea>
                                                </div> 
                                             </div>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-4">
                                                ...
                                                <input type="radio" class="form-check-input" name="page_status" id="page_status" value="1">
                                                Active
                                            <i class="input-frame"></i><i class="input-frame"></i></label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="page_status" id="page_status" value="0">
                                                Inactive
                                            <i class="input-frame"></i><i class="input-frame"></i></label>
                                        </div>                                       
                                                </div>
                                     ...
                                     <button type="submit" class="btn btn-primary mr-2">Edit Page</button>
                                       </form>
                            </div>
                        </div>
                    </div>
