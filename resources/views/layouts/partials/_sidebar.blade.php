              ...
              <ul class="nav sub-menu">
               ...
               <li class="nav-item">
                ...
                <li class="nav-item">
                  ...
                  <a href="{{route('usersModule.assignagent')}}" class="nav-link">Assign Agents To Supervisor</a>
          ...
          <li class="nav-item">
            ...
            <div class="" id="doctorsComponents">
              ...
              <ul class="nav sub-menu">
                  ...
                  <a href="{{route('agentsModule.agents')}}" class="nav-link">Agents</a>
            ...
            <a class="nav-link" data-toggle="collapse" href="#advancedUI" role="button" aria-expanded="false" aria-controls="advancedUI">
             ...
             <div class="collapse1" id="advancedUI">
              ...
              <li class="nav-item">
                  ...
                  <a href="{{route('supervisorsModule.supervisors')}}" class="nav-link">Supervisors</a>
            ...
            <a class="nav-link" data-toggle="collapse" href="#reportModule" role="button" aria-expanded="false" aria-controls="advancedUI">
             ...
             <div class="collapse1" id="reportModule">
              ...
              <li class="nav-item">
                  ...
                  <a href="{{route('reportsModule.dailydeliveryreport')}}" class="nav-link">Daily delivery report of DA</a>
                ...
                <li class="nav-item">
                  ...
                  <a href="{{route('reportsModule.weeklydeliveryreport')}}" class="nav-link">Weekly delivery report of DA</a>
                ...
                <li class="nav-item">
                  ...
                  <a href="{{route('reportsModule.cosolreportofda')}}" class="nav-link">Consolidated report of DA</a>
                ...
                <li class="nav-item">
                  ...
                  <a href="{{route('agentsModule.blacklistedDa')}}" class="nav-link">Blacklisted DA</a>
                ...
                <li class="nav-item">
                  ...
                  <a href="{{route('reportsModule.dawiseloginhr')}}" class="nav-link">DA wise login hours</a>
            ...
            <div class="" id="coreComponents">
              ...
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  ...
                  <a href="{{route('coreModule.administrativeSettings.warehouses')}}" class="nav-link">Warehouse</a>
                ...
                <li class="nav-item">
                  ...
                  <a href="{{route('coreModule.administrativeSettings.deliverytypes')}}" class="nav-link">Delivery Types</a>
                 ...
                 <li class="nav-item">
                  ...
                  <a href="{{route('coreModule.administrativeSettings.banks')}}" class="nav-link">Banks</a>
            ...
            <a class="nav-link" data-toggle="collapse" href="#ManagePagesModule" role="button" aria-expanded="false" aria-controls="advancedUI">
             ...
             <div class="collapse" id="ManagePagesModule">
              ...
              <li class="nav-item">
                  ...
                  <a href="{{route('pagesModule.managepages')}}" class="nav-link">Manage Pages</a>
